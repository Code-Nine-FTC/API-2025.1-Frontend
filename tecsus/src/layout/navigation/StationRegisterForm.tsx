...
export default function StationFormComponent() {
    ...
    async function handleCreate() {
        ...
        try {
            const resultado = await links.createStation(stationData)
    ...
    function handleParameterChange (event: SelectChangeEvent<number[]>){
        ...
        setParameterTypes(typeof value === 'string' ? value.split(',').map(Number) : value);
      };
    ...
    <Box className="estacao-wrapper">
        <Paper className="estacao-card">
            ...
            <form className="estacao-form" onSubmit={(e) => {e.preventDefault(); handleCreate()}}>
                <div className={'input-group-wrapper'}>
                    <div className="input-group">
                        <label className="input-label"><strong>Nome da estação</strong></label>
                        <input
                            type="text"
                            name={name}
                            value={name}
                ...
                <div className={'input-group-wrapper'}>
                    <div className="input-group">
                        <label className="input-label"><strong>UID</strong></label>
                        <input
                            type="text"
                            name={uid}
                            value={uid}
                ...
                <div className="row">
                    <div className={'input-group-wrapper input-bairro'}>
                        <div className="input-group">
                            <label className="input-label"><strong>País</strong></label>
                            <input
                                type="text"
                                name={country}
                                value={country}
                    ...
                    <div className={'input-group-wrapper input-cidade'}>
                        <div className="input-group">
                            <label className="input-label"><strong>Cidade</strong></label>
                            <input
                                type="text"
                                name={city}
                                value={city}
                    ...
                    <div className={'input-group-wrapper input-tiny'}>
                        <div className="input-group">
                            <label className="input-label"><strong>Estado</strong></label>
                            <input
                                type="text"
                                name={state}
                                value={state}
                ...
                <div className="row">
                    <div className={'input-group-wrapper input-coord'}>
                        <div className="input-group">
                            <label className="input-label"><strong>Latitude</strong></label>
                            <input
                                type="text"
                                name={latitude}
                                value={latitude}
                    ...
                    <div className={'input-group-wrapper input-coord'}>
                        <div className="input-group">
                            <label className="input-label"><strong>Longitude</strong></label>
                            <input
                                type="text"
                                name={longitude}
                                value={longitude}
                ...
                <div className="row">
                    <FormControl className="input-group-wrapper" fullWidth>
                        ...
                        input={<OutlinedInput id="select-multiple-parameters" label="Parâmetros" />}
                        renderValue={(selected) => (
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                            {selected.map((value) => {
                                const parameter = availableParameters.find(p => p.id === value);
                                return (
                                <Chip key={value} label={parameter ? parameter.name : value} />
                                );
                            })}
                            </Box>
                        )}
